...
public class admin_support_fragment_Adapter extends RecyclerView.Adapter<admin_support_fragment_Adapter.ViewHolder> {
    private ArrayList<user_room_request_data> list;
    private Context context;

    public admin_support_fragment_Adapter(ArrayList<user_room_request_data> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public admin_support_fragment_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.request_format, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull admin_support_fragment_Adapter.ViewHolder holder, int position) {
